package com.springcourse.example11.main;

import com.springcourse.example11.beans.Person;
import com.springcourse.example11.config.ProjectConfig;
...
public class Example11 {
    public static void main(String[] args) {
        ...
        //NOTE
        In scenarios where the bean which we want to autowire is not available then also we want to start the application then we use
