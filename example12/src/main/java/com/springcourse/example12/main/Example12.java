package com.springcourse.example12.main;

import com.springcourse.example12.beans.Person;
import com.springcourse.example12.config.ProjectConfig;
import com.springcourse.example12.beans.Vehicle;
...
public class Example12 {
    public static void main(String[] args) {
        ...
        Example shown in ProjectConfig Class and used in main class, auto wiring using @Autowired on setter method

        //NOTE
        @AutoWired can be marked/written on a field, setter, or a constructor

        In this project we will show how to use autoWire on class fields. But this not recommended approach as it does not allow
